...
DESCRIPTION = """JoystickData Subscriber example for Fast DDS python bindings"""
USAGE = ('python3 JoystickDataSubscriber.py')
...
class ReaderListener(fastdds.DataReaderListener):
    ...
    def on_data_available(self, reader):
        ...
        data = JoystickData.JoystickData()
        ...
        #print("Received {message} : {index}".format(message=data.buttonStates(), index=data.axisStates()))
...
class Reader:
    ...
    def __init__(self):
        ...
        self.topic_data_type = JoystickData.JoystickDataPubSubType()
